...
nextdeploy init --template minimal`}
      ...
      <p className="text-gray-300 mb-4">
        <strong className="text-white">Common flags:</strong>
      </p>
      <ul className="space-y-2 mb-6 text-gray-300">
        <li>
          <code className="bg-slate-900 px-2 py-1 rounded text-emerald-400">
...
nextdeploy ship --bluegreen`}
      ...
      <pre className="bg-slate-900 border border-slate-700 rounded-lg p-4 mb-4 overflow-x-auto">
        <code className="text-emerald-400">nextdeploy logs</code>
      </pre>
...
Memory: 256MB / 1GB`}
      ...
      <ul className="space-y-3 mb-8 text-gray-300">
        <li>
          ...
          - Self-updating CLI. Always stay on the latest version.
        </li>
        <li>
          <code className="bg-slate-900 px-2 py-1 rounded text-emerald-400">
            nextdeploy secrets
          </code>{" "}
          - Securely manage Environment Variables (Set, Get, List).
        </li>
        <li>
          <code className="bg-slate-900 px-2 py-1 rounded text-emerald-400">
            nextdeploy start
