  ...
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <p className="text-gray-300 text-lg mb-8">
        Learn how to deploy your first Next.js application with NextDeploy in
        just a few steps.
      </p>
      ...
      <ul className="space-y-2 mb-8 text-gray-300">
        ...
        <li className="flex gap-3">
          <span className="text-emerald-400">✓</span>
          <span>Doppler account for secrets (optional:in-progress)</span>
        </li>
      </ul>
      ...
      <p className="text-gray-300 mb-8">
        ...
        <ul className="space-y-1 mt-2 text-gray-300">
          ...
          <li>
            ...
            - Auto-generated route metadata cache
          </li>
        </ul>
      </p>
...
servers:
  - host: 192.168.1.100
    ssh_key: "~/.ssh/id_rsa"`}
      ...
      <p className="text-gray-300 mb-8">
        NextDeploy will securely connect to your server, install dependencies,
        and configure the background daemon automatically.
      </p>
      ...
      <p className="text-gray-300 mb-8">
        This generates a GitHub Actions workflow. Add your secrets to GitHub and
        NextDeploy handles everything on Git Push.
      </p>
...
nextdeploy deploy`}
      ...
      <p className="text-gray-300 mb-8">
        Because NextDeploy uses a Symlink architecture on VPS targets, rollbacks
        occur instantly without rebuilds.
      </p>
      ...
      <ol className="space-y-3 text-gray-300 list-decimal list-inside mb-8">
        ...
        <li>
          <strong>VPS:</strong> Bundle transferred, extracted to isolated
          release directory
        </li>
        <li>
          <strong>VPS:</strong> Dynamic port allocated, Next.js server booted
          via systemd
        </li>
        <li>
          <strong>VPS:</strong> Symlink updated to point to new release
        </li>
        <li>
          <strong>VPS:</strong> Caddy config dynamically rewritten and reloaded
          without dropping traffic
        </li>
        <li>
          <strong>AWS:</strong> Static assets intelligently pushed to
          S3/CloudFront
        </li>
        <li>
          <strong>AWS:</strong> Lambda Web Adapter attached for Next.js SSR
          backend
        </li>
      </ol>
      ...
      <p className="text-gray-300 mb-4">
        If port 3000 is already in use, change it in{" "}
        <code className="bg-slate-900 px-2 py-1 rounded text-emerald-400">
          nextdeploy.yml
        </code>
        :
