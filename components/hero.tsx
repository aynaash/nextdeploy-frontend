  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        {/* Main headline */}
        <h1 className="text-5xl md:text-7xl font-bold mb-6 mt-12 bg-gradient-to-r from-emerald-100 via-green-200 to-emerald-100 bg-clip-text text-transparent leading-tight">
          Next.js Deployment
          <br />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a
            href="#install"
            className="px-8 py-4 w-full sm:w-auto rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold transition-all duration-200 flex items-center justify-center gap-2 group shadow-lg shadow-emerald-500/20"
          >
            Start Shipping Now
          ...
          <a
            href="/docs"
            className="px-8 py-4 w-full sm:w-auto rounded-xl bg-slate-800/50 hover:bg-slate-800 text-white font-medium border border-slate-700 hover:border-slate-600 transition-all duration-200 flex items-center justify-center gap-2 backdrop-blur-sm"
          >
            Read Documentation
          </a>
        </div>
        ...
        <div
          id="install"
          className="max-w-2xl mx-auto group scroll-mt-24"
        >
          <div className="relative bg-gradient-to-br from-slate-950/80 to-slate-900/60 backdrop-blur-sm rounded-2xl border border-slate-700/50 overflow-hidden shadow-2xl text-left">
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-slate-800/40 border-b border-slate-700/50">
              ...
              <button
                onClick={copyCmd}
                className="flex items-center gap-2 px-3 py-1 text-xs text-gray-400 hover:text-emerald-300 hover:bg-slate-700/50 rounded-md transition-all duration-200 font-medium"
              >
                {copied ? (
            ...
            <div className="p-8 md:p-10 font-mono text-sm sm:text-base">
              <div className="flex flex-col gap-4 group">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-gray-500 mt-6 text-sm flex items-center gap-2 italic">
                      # {activeTab.desc}
                    </div>
                  </div>
                </div>
