  ...
  return (
    <div className="prose prose-invert max-w-none">
      ...
      <pre className="bg-slate-900 border border-slate-700 rounded-lg p-4 mb-8 overflow-x-auto">
        <code className="text-emerald-400">curl https://nextdeploy.one/nextdeploy.sh | sh</code>
      </pre>
      ...
      <p className="text-gray-300 mb-4">If deploying to a VPS, use the CLI to securely configure the daemon and Caddy webserver via Trust-On-First-Use (TOFU) SSH:</p>
      ...
      <ul className="space-y-2 mb-8 text-gray-300">
        <li className="flex gap-2">
          ...
          <span><strong>Systemd</strong> - For service management</span>
        </li>
      ...
      <ul className="space-y-2 mb-8 text-gray-300">
        ...
        <li className="flex gap-2">
          <span className="text-emerald-400">✓</span>
          <span><strong>Caddy</strong> - For reverse proxy (with valid Let's Encrypt SSL)</span>
        </li>
        <li className="flex gap-3">
          <span className="text-emerald-400">•</span>
